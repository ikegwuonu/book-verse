...
const PDFControl = ({ control }: PDFControlProps) => {
  ...
  function handleSearch() {
    // In a real implementation, you would use PDF.js text layer to search
  ...
  return (
    <>
      <div className="sticky top-16 z-10 bg-white dark:bg-gray-800 shadow-md h-fit mb-4">
              ...
              <Button
                onClick={() => {
                  ...
                  if (total > 0) {
                    ...
                    setPageNumber(
                      matches[(currentMatchIndex + 1) % total].page
                    );
                  }
                }}
              >
              ...
              <Button
                onClick={() => {
                  ...
                  if (total > 0) {
                    ...
                    setPageNumber(
                      matches[(currentMatchIndex - 1 + total) % total].page
                    );
                  }
                }}
              >
